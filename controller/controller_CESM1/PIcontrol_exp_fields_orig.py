...
logheader=['Timestamp','dT0','sum(dT0)','L0','int_weight','n_AODVISstdn',
...
prescribed_strataero_prevyear           = f'ozone_strataero_2019-2100_SSP585_CAMfeedback-{timestamp-1}.nc'
prescribed_strataero_curyear            = f'ozone_strataero_2019-2100_SSP585_CAMfeedback-{timestamp}.nc'
