...
casename='lres_b.e10.B2000_CAM5.f09_g16.feedforward_2050.001' 
print(f'INFO: casename = {casename}')

casepath='/home/renew1/cesm/cesm_tags/cesm1_0_4/scripts/'+casename
scratchdir='/scratch-local/renew1/'+casename+'/temp_stuff' 
frequency='1y'
maxrest=99
...
if (DO_BRANCH): 
    ...
    runname = 'lres_b.e10.B2000_CAM5.f09_g16.feedforward_2050.001'
    hist_dir = f'/projects/0/nwo2021025/archive/{runname}/atm/hist'    
    #branch_year = 2020
    #hist_dir = f'/projects/0/nwo2021025/archive/{runname}_{branch_year}/atm/hist'    
    ...
    runname = casename
    archivepaths=len(variables)*['/projects/0/nwo2021025/archive/'+runname+'/atm/hist'] # do NOT include a '/' at the end of each path'
