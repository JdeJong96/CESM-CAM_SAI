...
def main():
    ...
    if 'ncol' in ds.dims:
        area = xr.open_dataset("/home/jasperdj/analysis/grid/ne30_g16.grid.nc").area
        gmean = lambda da: da.weighted(area).mean('ncol', keep_attrs=True)
    else:
...
if __name__ == '__main__':
    ...
    t0 = perf_counter()
    client = Client(n_workers=16, threads_per_worker=1) # for parallel opening
